...
Blockly.blockRendering.TopRow.prototype.hasLeftSquareCorner = function(a) {
    var b = (a.hat ? "cap" === a.hat : Blockly.BlockSvg.START_HAT) && !a.outputConnection && !a.previousConnection,
...
Blockly.blockRendering.RenderInfo.prototype.populateTopRow_ = function() {
    var a = !!this.block_.previousConnection,
        b = (this.block_.hat ? "cap" === this.block_.hat : Blockly.BlockSvg.START_HAT) && !this.outputConnection && !a;
